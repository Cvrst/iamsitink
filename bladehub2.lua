...
local Window = Fluent:CreateWindow({
    Title = "Blade Hub 2 Beta | Blox Kid",
    SubTitle = "Soucrce by Fai Fao and the script in beta",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=15777441488"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.FastAttackBlade_Mode = Value
	if _G.FastAttackBlade_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttackBlade_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.2
	elseif _G.FastAttackBlade_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.01
	end
end)
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( The fes is end )",Description = "Cày Kẹo ( Chỉ Cấp Độ Tối Đa )", Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = " Enable Bring Mob",Description = "Gom Quái", Default = true })
...
while wait() do
    pcall(function()
        if _G.FastAttackBlade then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackBlade
        end
    end)
end
end)
...
_G.SelectFruit = "Kitsune-Kitsune"
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Bro,Go To Third Sea Please !!!")
end
...
----------------------------------------------------------------------------------------------------------------------------------------------
InterfaceManager:SetFolder("BladeScriptHub")
SaveManager:SetFolder("BladeScriptHub/specific-game")
Window:SelectTab(1)
Fluent:Notify({
    Title = "Blade Hub 2 Beta",
